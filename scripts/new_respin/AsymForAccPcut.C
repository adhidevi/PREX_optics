...
void AsymForAccPcut(int run, Float_t E){
  ...
  TCut cut = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.04&&L.gold.ph<0.05&&L.gold.dp<-0.002&&fEvtHdr.fEvtType==1");
  TCut cutADCup = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.04&&L.gold.ph<0.05&&L.gold.dp<-0.002&&fEvtHdr.fEvtType==1&&P.upQadcL> %f",upadc_cutL);
  TCut cutPEDup = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.04&&L.gold.ph<0.05&&L.gold.dp<-0.002&&fEvtHdr.fEvtType==1&&P.upQadcL< %f",upadc_cutL);
...
//  gPad->SetLogy();
  ...
  double thisThtg, thisPhtg, thisP, thisdP, thisDet;
...
//  double E = 0.95;//beam energy
  ...
  for(long i = 0; i < n; i++){ 
   ...
   //VDC cut and pCut
  if( thisu1==1 && thisv1==1 && thisu2==1 && thisv2==1 && thisThtg>-0.08 && thisThtg<0.08 && thisPhtg>-0.04 && thisPhtg<0.05 && thisdP <-0.002 && thisP > pCut[iCut] && thisTrig==1){
 ...
 //Histograms 
 Q2[iCut] = new TH1F(Form("Q2_%.4f",pCut[iCut]),"Q^{2} (GeV/c)^{2}",150,0,0.015);
 ...
 gSystem->Exec(Form("pdfunite ./temp1/plot*.pdf ./plots/all_pCut_run%d.pdf",run));
 ...
 for(int iCut=0;iCut<nCut;iCut++){
 outfile<<EdgeP<<"\t"<<pCut[iCut]<<"\t"<<Theta[iCut]->GetMean()<<"\t"<<Theta[iCut]->GetRMS()<<"\t"<<Asym[iCut]->GetMean()<<"\t"<<Asym[iCut]->GetRMS()<<"\t"<<SAsym[iCut]->GetMean()<<"\t"<<SAsym[iCut]->GetRMS()<<"\t"<<Q2[iCut]->GetMean()<<"\t"<<Q2[iCut]->GetRMS()<<"\t"<<sens[iCut]->GetMean()<<"\t"<<sens[iCut]->GetRMS()<<"\t"<<epfit->GetParameter(1)-pCut[iCut]<<"\t"<<hpup2Cpy->Interpolate(pCut[iCut])<<endl;
 ...
 outfile.close();
  ...
  TCut cut = Form("R.vdc.u1.nclust==1&&R.vdc.v1.nclust==1&&R.vdc.u2.nclust==1&&R.vdc.v2.nclust==1&&R.gold.th>-0.08&&R.gold.th<0.08&&R.gold.ph>-0.04&&R.gold.ph<0.05&&R.gold.dp<-0.002&&fEvtHdr.fEvtType==1");
  TCut cutADCup = Form("R.vdc.u1.nclust==1&&R.vdc.v1.nclust==1&&R.vdc.u2.nclust==1&&R.vdc.v2.nclust==1&&R.gold.th>-0.08&&R.gold.th<0.08&&R.gold.ph>-0.04&&R.gold.ph<0.05&&R.gold.dp<-0.002&&fEvtHdr.fEvtType==1&&P.upQadcR> %f",upadc_cutR);
  TCut cutPEDup = Form("R.vdc.u1.nclust==1&&R.vdc.v1.nclust==1&&R.vdc.u2.nclust==1&&R.vdc.v2.nclust==1&&R.gold.th>-0.08&&R.gold.th<0.08&&R.gold.ph>-0.04&&R.gold.ph<0.05&&R.gold.dp<-0.002&&fEvtHdr.fEvtType==1&&P.upQadcR< %f",upadc_cutR);
...
//  double E = 0.95;//beam energy
  ...
  for(long i = 0; i < n; i++){ 
   ...
   //VDC cut and pCut
  if( thisu1==1 && thisv1==1 && thisu2==1 && thisv2==1 && thisThtg>-0.08 && thisThtg<0.08 && thisPhtg>-0.04 && thisPhtg<0.04 && thisdP<-0.002 && thisP > pCut[iCut] && thisTrig==1){
 ...
 std::cout << "Theta " << Theta[iCut]->GetMean() << "  " << "<A> " << Asym[iCut]->GetMean() << " " << "Stretched <A>" << SAsym[iCut]->GetMean() << "  " << "Q2 " << Q2[iCut]->GetMean() << "  " << sens[iCut]->GetMean() <<"\t"<<epfit->GetParameter(1)-pCut[iCut]<<"\t"<<hpup2Cpy->Interpolate(pCut[iCut])<< std::endl;
}
 outfile.close();
}
}
