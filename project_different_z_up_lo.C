...
#include <fstream>
#include <iostream>
void project_different_z_up_lo(int run, double detZ){ 
//change the x_cut on rad tail based on your prefered Z location
  ...
  if(run < 10000){
      ...
      TH1F* hlq = new TH1F("hlq", "ADC raw;ADC raw;Events/CH", 400,400,800);
      hlq->SetLineColor(3);
      T->Project(hlq->GetName(),"P.loQadcL");
//      hlq->Draw();
      huq->Draw("same");
      ...
      TH1F* hlqCpy = (TH1F*)hlq->Clone("hlqCpy");
      hlqCpy->GetXaxis()->SetRangeUser(loadc_cutL_approx-10,loadc_cutL_approx+10);
      double loadc_cutL = hlqCpy->GetBinCenter(hlqCpy->GetMinimumBin());
      cout<<"upadc_cutL: "<<upadc_cutL<<"\tloadc_cutL: "<<loadc_cutL<<endl;

      TLine* ped_line = new TLine(upadc_cutL,0.0,upadc_cutL,huq->GetMaximum());
      ped_line->SetLineColor(9);
      ped_line->SetLineWidth(2);
      ped_line->Draw();
      TLine* ped_line_lo = new TLine(loadc_cutL,0.0,loadc_cutL,hlq->GetMaximum());
      ped_line_lo->SetLineColor(9);
      ped_line_lo->SetLineWidth(2);
//      ped_line_lo->Draw();
...
//      latex.DrawLatex(0.70,0.80,"P.loQadcL");
      latex.SetTextColor(9);
      latex.DrawLatex(0.70,0.75,"Ped. cut");

//      TCut cut = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&(L.tr.th[0]<0.05&&L.tr.th[0]>-0.2&&L.tr.ph[0]<0.1&&L.tr.ph[0]>-0.1)&&(L.tr.tg_th[0]<0.055&&L.tr.tg_th[0]>-0.055&&L.tr.tg_ph[0]>-0.018&&L.tr.tg_ph[0]<0.026)&&(P.evtypebits&2)==2");
      TCut cut = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)");
//      TCut cutADCup = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&(L.tr.th[0]<0.05&&L.tr.th[0]>-0.2&&L.tr.ph[0]<0.1&&L.tr.ph[0]>-0.1)&&(L.tr.tg_th[0]<0.055&&L.tr.tg_th[0]>-0.055&&L.tr.tg_ph[0]>-0.018&&L.tr.tg_ph[0]<0.026)&&(P.evtypebits&2)==2&&P.upQadcL> %f",upadc_cutL);
      TCut cutADCup = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&P.upQadcL> %f",upadc_cutL);
 //     TCut cutPEDup = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&(L.tr.th[0]<0.05&&L.tr.th[0]>-0.2&&L.tr.ph[0]<0.1&&L.tr.ph[0]>-0.1)&&(L.tr.tg_th[0]<0.055&&L.tr.tg_th[0]>-0.055&&L.tr.tg_ph[0]>-0.018&&L.tr.tg_ph[0]<0.026)&&(P.evtypebits&2)==2&&P.upQadcL< %f",upadc_cutL);
      TCut cutPEDup = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&P.upQadcL< %f",upadc_cutL);
//      TCut cutADClo = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&(L.tr.th[0]<0.05&&L.tr.th[0]>-0.2&&L.tr.ph[0]<0.1&&L.tr.ph[0]>-0.1)&&(L.tr.tg_th[0]<0.055&&L.tr.tg_th[0]>-0.055&&L.tr.tg_ph[0]>-0.018&&L.tr.tg_ph[0]<0.026)&&(P.evtypebits&2)==2&&P.loQadcL> %f",loadc_cutL);
      TCut cutADClo = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&P.loQadcL> %f",loadc_cutL);
//      TCut cutPEDlo = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&(L.tr.th[0]<0.05&&L.tr.th[0]>-0.2&&L.tr.ph[0]<0.1&&L.tr.ph[0]>-0.1)&&(L.tr.tg_th[0]<0.055&&L.tr.tg_th[0]>-0.055&&L.tr.tg_ph[0]>-0.018&&L.tr.tg_ph[0]<0.026)&&(P.evtypebits&2)==2&&P.loQadcL< %f",loadc_cutL);
      TCut cutPEDlo = Form("(L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1)&&P.loQadcL< %f",loadc_cutL);
      double x_edge;
      if(detZ==90)
      ...
      TH1F* hylo2 = new TH1F("hylo2", "Projected y on detector plane + adc>cut", 200, -0.06, 0.01);
      TH1F* hylo3 = new TH1F("hylo3", "Projected y on detector plane + adc<cut", 200, -0.06, 0.01);
      ...
      T->Project(hylo2->GetName(), Form("L.tr.y[0]+%f*L.tr.ph[0]",detZ/100.0), cutADClo+x_cut);
      T->Project(hylo3->GetName(), Form("L.tr.y[0]+%f*L.tr.ph[0]",detZ/100.0), cutPEDlo+x_cut);
      hy1->SetXTitle(Form("L.tr.y[0]+%1.1f*L.tr.ph[0] (m)",detZ/100.0));
      hy1->SetLineColor(1);
      hyup2->SetLineColor(2);
      hyup3->SetLineColor(4);
      hylo2->SetLineColor(6);
      hylo3->SetLineColor(7);
      hy1->Draw();
      hyup2->Draw("same");
      hyup3->Draw("same");
//      hylo2->Draw("same");
...
//      latex.DrawLatex(0.20,0.70,"DS accepted");
//      latex.SetTextColor(7);
//      latex.DrawLatex(0.20,0.65,"DS missed");
      ...
      TH1F* hxlo2 = new TH1F("hxlo2", "Projected x on detector plane + adc>cut", 300, -0.14, 0.03);
      TH1F* hxlo3 = new TH1F("hxlo3", "Projected x on detector plane + adc<cut", 300, -0.14, 0.03);
      ...
      T->Project(hxlo2->GetName(), Form("L.tr.x[0]+%f*L.tr.th[0]",detZ/100.0), cutADClo);
      T->Project(hxlo3->GetName(), Form("L.tr.x[0]+%f*L.tr.th[0]",detZ/100.0), cutPEDlo);
      hx1->SetXTitle(Form("L.tr.x[0]+%1.1f*L.tr.th[0] (m)",detZ/100.0));
      hx1->SetLineColor(1);
      hxup2->SetLineColor(2);
      hxup3->SetLineColor(4);
      hxlo2->SetLineColor(6);
      hxlo3->SetLineColor(7);
      hx1->Draw();
      hxup2->Draw("same");
      hxup3->Draw("same");
//      hxlo2->Draw("same");
...
//      TLine* y1 = new TLine(-0.01,-0.14,-0.01,0.04);
//      TLine* y2 = new TLine(-0.01-0.035,-0.14,-0.01-0.035,0.04);
//      y1->SetLineColor(2);
//      y2->SetLineColor(2);
//      y1->Draw();
//      y2->Draw();
