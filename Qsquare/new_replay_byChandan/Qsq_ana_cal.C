...
//      Float_t Ebeam = 0.953374;//GeV
  ...
  if(run < 10000){
      ...
      TCut cut_wadc = Form("((P.evtypebits&2)==2&&L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.04&&L.gold.ph<0.05&&L.gold.dp<-0.002&&P.upQadcL>%f)",upADCcut);
//      TCut cut_wadc = Form("((P.evtypebits&2)==2&&L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&P.upQadcL>%f)",upADCcut);
      ...
      double pedMean = fpedpar[1];
      cout<<"pedMean:"<<pedMean<<endl;
      TCut cut_wadc = Form("((P.evtypebits&2)==2&&R.vdc.u1.nclust==1&&R.vdc.v1.nclust==1&&R.vdc.u2.nclust==1&&R.vdc.v2.nclust==1&&R.gold.th>-0.08&&R.gold.th<0.08&&R.gold.ph>-0.04&&R.gold.ph<0.05&&R.gold.dp<-0.002&&P.upQadcR>%f)",upADCcut);
