...
void Qsq_only_x_p_adc_cut(int run, TString target, TString date, double Ebeam){

   TString path = "/chafs1/work1/prex_counting/Qsq_Oct19";
  ...
  TCut cut = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.05&&L.gold.ph<0.05&&L.gold.dp>-0.04&&L.gold.dp<0.002&&(P.evtypebits&2)==2");
  TCut cut_wadc = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.05&&L.gold.ph<0.05&&L.gold.dp>-0.04&&L.gold.dp<0.002&&(P.evtypebits&2)==2&&P.upQadcL> %f",upadc_cutL);
  TCut cut_wped = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.05&&L.gold.ph<0.05&&L.gold.dp>-0.04&&L.gold.dp<0.002&&(P.evtypebits&2)==2&&P.upQadcL< %f",upadc_cutL);
...
//  gPad->SetBottomMargin(0);
  ...
  TCut xCut = Form("L.vdc.u1.nclust==1&&L.vdc.v1.nclust==1&&L.vdc.u2.nclust==1&&L.vdc.v2.nclust==1&&L.gold.th>-0.08&&L.gold.th<0.08&&L.gold.ph>-0.05&&L.gold.ph<0.05&&L.gold.dp>-0.04&&L.gold.dp<0.002&&(P.evtypebits&2)==2&&L.tr.x[0]+1.3*L.tr.th[0]> %f",EdgeX);
...
//  gPad->SetTopMargin(0);
  ...
  outfile<<run<<"\t"<<Ebeam<<"\t"<<target.Data()<<"\t"<<date.Data()<<"\t"<<upadc_cutL<<"\t"<<EdgeX<<"\t"<<EdgeP<<"\t"<<Q2adc->GetMean()<<"\t"<<Q2adc->GetRMS()<<"\t"<<Q2xcut->GetMean()<<"\t"<<Q2xcut->GetRMS()<<"\t"<<Q2pcut->GetMean()<<"\t"<<Q2pcut->GetRMS()<<endl;
  outfile.close();
