...
void Accfunc(){
  ...
  for(int i = 1; i < 6; i++){ T->Add(Form("/lustre/expphy/volatile/halla/parity/ryanrich/Ebeam953/TargNominal/Zero1_SandwichLHRS_PREX_0.0_%i.root",i)); }
     ...
     double momcut = 2.2;//MeV from the elastic peak
