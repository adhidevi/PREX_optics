...
void testR(int run,double sept,double ADC,double th0, double dp, double off){
...
double thisEvt;
  ...
  for(int c = 1; c < 6; c++){ T1->Add(Form("/lustre/expphy/volatile/halla/parity/ryanrich/Ebeam953_4by6/TargNominal/Zero1_SandwichRHRS_PREX_%.1f_%i.root",sept,c)); }
