...
double thisEvt;
  ...
  T->Add(Form("/chafs1/work1/prex_counting/Qsq_Oct22/prexLHRS_%i_-1*.root",run));

  TChain *T1 = new TChain("T");
  for(int i = 1; i < 6; i++){ T1->Add(Form("/lustre/expphy/volatile/halla/parity/ryanrich/Ebeam953_4by6/TargNominal/Zero1_SandwichLHRS_PREX_%.1f_%i.root",sept,i)); }
