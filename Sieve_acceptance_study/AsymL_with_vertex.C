...
void AsymL_with_vertex(int run,double sept,double ADC,double th0, double peakpos, double simMomCut, double Ebeam, double YColl_offset){
...
double thisEvt;
 ...
 ofstream outfile(Form("./TextFiles/septum_scan_Ycoll_scan_oldDatabase_run%d.csv",run),ios_base::app);
 ...
 outfile.close();
 gSystem->Exec(Form("pdfunite ./temp/*.pdf ./plots/septum_%.1f_Ycoll_%.3f_oldDatabase_run%d.pdf",sept,YColl_offset,run));
