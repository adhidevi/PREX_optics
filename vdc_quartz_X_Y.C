...
#include <fstream>
#include <iostream>
void vdc_quartz_X_Y(int run_num){ 
...
//      TCut y_cut = "((L.tr.y[0]+0.9*L.tr.ph[0]) < -0.013)&&((L.tr.y[0]+0.9*L.tr.ph[0]) > -0.035)";
      ...
      TH1F* hxN1 = new TH1F("hxN1", "Projected x on plane", 300, -0.14, 0.03);
      TH1F* hxN2 = new TH1F("hxN2", "Projected x on vdc plane + adc>cut", 300, -0.14, 0.03);
      TH1F* hxN3 = new TH1F("hxN3", "Projected x on plane + adc<cut", 300, -0.14, 0.03);
      ...
      T->Project(hxN1->GetName(), "L.tr.x[0]", cut); 
      T->Project(hxN2->GetName(), "L.tr.x[0]", cut_wadc);
      T->Project(hxN3->GetName(), "L.tr.x[0]", cut_wadc_ped);
      ...
      hxN2->SetLineColor(7);
      hxN3->SetLineColor(8);
      hxN1->SetTitle("Transport x;Transport x projected to quartz (m)");
      hxN1->Draw();
//      hx2->Draw("same");
//      hx3->Draw("same");
      hx1->Draw("same");
...
//      latex.DrawLatex(0.15,0.75, Form("Missed @ 90 cm"));
      ...
      latex.DrawLatex(0.15,0.80, Form("All @ 0 cm"));
//      latex.SetTextColor(7);
//      latex.DrawLatex(0.15,0.65, Form("Accepted @ 0 cm"));
//      latex.SetTextColor(8);
//      latex.DrawLatex(0.15,0.60, Form("Missed @ 0 cm"));
      ...
      TH1F* hyN1 = new TH1F("hyN1", "Projected y on vdc plane", 200, -0.06, 0.01);
      TH1F* hyN2 = new TH1F("hyN2", "Projected y on vdc plane + adc>cut", 200, -0.06, 0.01);
      TH1F* hyN3 = new TH1F("hyN3", "Projected y on vdc plane + adc<cut", 200, -0.06, 0.01);

      T->Project(hy1->GetName(), "L.tr.y[0]+0.9*L.tr.ph[0]", cut); 
      T->Project(hy2->GetName(), "L.tr.y[0]+0.9*L.tr.ph[0]", cut_wadc);
      T->Project(hy3->GetName(), "L.tr.y[0]+0.9*L.tr.ph[0]", cut_wadc_ped);
      T->Project(hyN1->GetName(), "L.tr.y[0]", cut); 
      T->Project(hyN2->GetName(), "L.tr.y[0]", cut_wadc);
//      T->Project(hyN3->GetName(), "L.tr.y[0]", cut_wadc_ped + x_cut140+y_cut);
      T->Project(hyN3->GetName(), "L.tr.y[0]", cut_wadc_ped);
      hy1->SetLineColor(1);
      hy2->SetLineColor(2);
      hy3->SetLineColor(4);
      hyN1->SetLineColor(6);
      hyN2->SetLineColor(7);
      hyN3->SetLineColor(8);
      hy1->SetTitle("Transport y;Transport y (m)");
      hy1->Draw();
//      hy2->Draw("same");
//      hy3->Draw("same");
      hyN1->Draw("same");
...
//      hyN3->Draw("same");
      ...
      c2->SaveAs(Form("plots/vdc_quartzL_x_y_run%d.pdf",run_num));
    }else{
      // RHRS
...
//      TCut y_cut = "((R.tr.y[0]+0.9*R.tr.ph[0]) < -0.013)&&((R.tr.y[0]+0.9*R.tr.ph[0]) > -0.035)";
      ...
      TH1F* hx2 = new TH1F("hx2", "Projected x on detector plane + adc>cut", 300, -0.14, 0.03);
      TH1F* hx3 = new TH1F("hx3", "Projected x on detector plane + adc<cut", 300, -0.14, 0.03);
      TH1F* hxN1 = new TH1F("hxN1", "Projected x on vdc plane", 300, -0.14, 0.03);
      TH1F* hxN2 = new TH1F("hxN2", "Projected x on vdc plane + adc>cut", 300, -0.14, 0.03);
      TH1F* hxN3 = new TH1F("hxN3", "Projected x on vdc plane + adc<cut", 300, -0.14, 0.03);
      ...
      T->Project(hxN1->GetName(), "R.tr.x[0]", cut); 
      T->Project(hxN2->GetName(), "R.tr.x[0]", cut_wadc);
      T->Project(hxN3->GetName(), "R.tr.x[0]", cut_wadc_ped);
      ...
      hxN2->SetLineColor(7);
      hxN3->SetLineColor(8);
      hxN1->SetTitle("Transport X;Transport x (m)");
      hxN1->Draw();
//      hx2->Draw("same");
//      hx3->Draw("same");
      hx1->Draw("same");
...
//      latex.DrawLatex(0.15,0.60, Form("Missed @ 0 cm"));
      ...
      TH1F* hyN1 = new TH1F("hyN1", "Projected y on vdc plane", 200, -0.04, 0.04);
      TH1F* hyN2 = new TH1F("hyN2", "Projected y on vdc plane + adc>cut", 200, -0.04, 0.04);
      TH1F* hyN3 = new TH1F("hyN3", "Projected y on vdc plane + adc<cut", 200, -0.04, 0.04);

      T->Project(hy1->GetName(), "R.tr.y[0]+0.9*R.tr.ph[0]", cut); 
      T->Project(hy2->GetName(), "R.tr.y[0]+0.9*R.tr.ph[0]", cut_wadc);
      T->Project(hy3->GetName(), "R.tr.y[0]+0.9*R.tr.ph[0]", cut_wadc_ped);
      T->Project(hyN1->GetName(), "R.tr.y[0]", cut); 
      T->Project(hyN2->GetName(), "R.tr.y[0]", cut_wadc);
      T->Project(hyN3->GetName(), "R.tr.y[0]", cut_wadc_ped);
      hy1->SetLineColor(1);
      hy2->SetLineColor(2);
      hy3->SetLineColor(4);
      hyN1->SetLineColor(6);
...
//      hyN3->Draw("same");
      ...
      c2->SaveAs(Form("plots/vdc_quartzR_x_y_run%d.pdf",run_num));
    }
