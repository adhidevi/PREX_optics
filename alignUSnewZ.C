...
//      TCut trig_cut = "";
      ...
      TCut x_cut = "(L.tr.x[0]+1.4*L.tr.th[0]) > -0.0725";
      TCut y_cut = "";
//      TCut y_cut = "((L.tr.y[0]+1.4*L.tr.ph[0]) < -0.013)&&((L.tr.y[0]+1.4*L.tr.ph[0]) > -0.035)";
...
//      TCut x_cut = "";
      ...
      T->Project(hy1->GetName(), "L.tr.y[0]+1.4*L.tr.ph[0]", cut + x_cut); 
      T->Project(hy2->GetName(), "L.tr.y[0]+1.4*L.tr.ph[0]", cut_wadc + x_cut);
      T->Project(hy3->GetName(), "L.tr.y[0]+1.4*L.tr.ph[0]", cut_wadc_ped + x_cut+y_cut);
      hy1->SetXTitle("L.tr.y[0]+1.4*L.tr.ph[0] (m)");
...
//      latex.DrawLatex(-.045, hy1->GetMaximum()/4., Form("fract passed_adc_cut/all: %.2f", frac_y));
      ...
      T->Project(hx1->GetName(), "L.tr.x[0]+1.4*L.tr.th[0]", cut); 
      T->Project(hx2->GetName(), "L.tr.x[0]+1.4*L.tr.th[0]", cut_wadc);
      T->Project(hx3->GetName(), "L.tr.x[0]+1.4*L.tr.th[0]", cut_wadc_ped+y_cut);
      hx1->SetXTitle("L.tr.x[0]+1.4*L.tr.th[0] (m)");
 ...
 //     xpt->Draw();
      ...
      T->Project(h2d1->GetName(), "L.tr.x[0]+1.4*L.tr.th[0]:L.tr.y[0]+1.4*L.tr.ph[0]",cut);
      ...
      float nAccept = T->Project(h2d2->GetName(),"L.tr.x[0]+1.4*L.tr.th[0]:L.tr.y[0]+1.4*L.tr.ph[0]",cut_wadc);
      ...
      TCut ePeak = "L.tr.y[0]+1.4*L.tr.ph[0]>-0.02 && L.tr.x[0]+1.4*L.tr.th[0]>-0.05";
      float nMiss = T->Draw("L.tr.x[0]+1.4*L.tr.th[0]:L.tr.y[0]+1.4*L.tr.ph[0]",cut_wadc_ped + ePeak);
      ...
      T->Project(h2d3->GetName(), "L.tr.x[0]+1.4*L.tr.th[0]:L.tr.y[0]+1.4*L.tr.ph[0]",cut_wadc_ped);
      ...
      ptPPE->Draw();
      c2->SaveAs(Form("plots/USL_alignment_newZ_run%d.pdf",run_num));
    }else{
      // RHRS
...
//      TCut trig_cut = "(P.evtypebits&2)==2";
      ...
      TCut x_cut = "(R.tr.x[0]+1.4*R.tr.th[0]) > -0.077";
//      TCut x_cut = "";
      TCut cut_basic = trig_cut + vdc_cut;
      TCut cut = cut_basic + tr_cut + tg_cut;
      ...
      T->Project(hy1->GetName(), "R.tr.y[0]+1.4*R.tr.ph[0]", cut + x_cut); 
      T->Project(hy2->GetName(), "R.tr.y[0]+1.4*R.tr.ph[0]", cut_wadc + x_cut);
      T->Project(hy3->GetName(), "R.tr.y[0]+1.4*R.tr.ph[0]", cut_wadc_ped + x_cut);
      hy1->SetXTitle("R.tr.y[0]+1.4*R.tr.ph[0] (m)");
      hy1->SetLineColor(kBlack);
      hy2->SetLineColor(kRed);
      hy3->SetLineColor(kBlue);
      hy1->Draw();
      ...
      T->Project(hx1->GetName(), "R.tr.x[0]+1.4*R.tr.th[0]", cut); 
      T->Project(hx2->GetName(), "R.tr.x[0]+1.4*R.tr.th[0]", cut_wadc);
      T->Project(hx3->GetName(), "R.tr.x[0]+1.4*R.tr.th[0]", cut_wadc_ped);
      hx1->SetXTitle("R.tr.x[0]+1.4*R.tr.th[0] (m)");
      hx1->SetLineColor(kBlack);
      hx2->SetLineColor(kRed);
      ...
      T->Project(h2d1->GetName(), "R.tr.x[0]+1.4*R.tr.th[0]:R.tr.y[0]+1.4*R.tr.ph[0]",cut);
      h2d1->SetXTitle("Projected y (m)");
      h2d1->SetYTitle("Projected x (m)");
      h2d1->Draw("COLZ");
      ...
      float nAccept = T->Project(h2d2->GetName(),"R.tr.x[0]+1.4*R.tr.th[0]:R.tr.y[0]+1.4*R.tr.ph[0]",cut_wadc);
      h2d2->SetXTitle("Projected y (m)");
      h2d2->SetYTitle("Projected x (m)");
      h2d2->Draw("COLZ");
      ...
      gPad->SetGridx();
      gPad->SetGridy();
      TCut ePeak = "R.tr.y[0]+1.4*R.tr.ph[0]<-0.01 && R.tr.x[0]+1.4*R.tr.th[0]>-0.05";
      float nMiss = T->Draw("R.tr.x[0]+1.4*R.tr.th[0]:R.tr.y[0]+1.4*R.tr.ph[0]",cut_wadc_ped + ePeak);
      cout<<"Accept:"<<nAccept<<"\t"<<"Miss:"<<nMiss<<"\t"<<"Ratio:"<<nMiss/nAccept<<endl;

      TH2F* h2d3 = new TH2F("h2d3", "Projected x vs y adc < cut", 150, -0.05, 0.05, 150, -0.10, 0.01);
      T->Project(h2d3->GetName(), "R.tr.x[0]+1.4*R.tr.th[0]:R.tr.y[0]+1.4*R.tr.ph[0]",cut_wadc_ped);
      h2d3->SetXTitle("Projected y (m)");
      h2d3->SetYTitle("Projected x (m)");
      h2d3->Draw("COLZ");
      ...
      ptPPE->SetFillColor(0);
      ptPPE->Draw();
      c2->SaveAs(Form("plots/USR_alignment_newZ_run%d.pdf",run_num));
    }
